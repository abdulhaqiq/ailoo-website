...
const footerLinks = {
  'Services': [
    ...
    { label: 'Flight Services', href: '/flight' },
    { label: 'Home Rental', href: '/home-rental' },
    { label: 'Car Rentals', href: '/car-rental' },
    { label: 'Daily Subscription', href: '/daily-subscription' },
  ],
  'Company': [
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div className="space-y-2">
              <p className="text-gray-300 text-sm">© Ailoo Transportation 2025</p>
              <p className="text-gray-300 text-sm">Ailoo HQ - Riyadh, Saudi Arabia</p>
            </div>
            ...
            <div className="lg:max-w-md">
              <p className="text-gray-300 text-xs leading-relaxed">
                Ailoo is a transportation platform providing ride-hailing and flight booking services. All rides are provided by licensed third-party drivers, and all flights are operated by properly licensed airlines.
              </p>
            </div>
          </div>
        </div>
